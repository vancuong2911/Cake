...
<body>
        ...
        <!-- Message Content -->
        <div class="message_email" style="text-align: center;font-size: 2rem;margin-top:100px;">
            <h1>Gửi mail thành công</h1>
            <p>Thanks you for contacting me. I will get back to you  as soon as possible!</p>
